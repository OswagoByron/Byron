          ...
          <li> <a href="listing_2.html">Computers</a>
            <div class="s_submenu">
              ...
              <ul class="s_list_1 clearfix">
                ...
                <li><a href="listing_1.html">Accessories</a></li>
               
		<li><a href="listing_1.html">Printers</a></li>
		
              </ul>
              <span class="clear border_eee"></span>
              <h3>Computers Brands</h3>
              <ul class="s_list_1 clearfix">
                <li><a href="listing_1.html">Dell</a></li>
                <li><a href="listing_1.html">Acer</a></li>
		<li><a href="listing_1.html">Toshiba</a></li>
		<li><a href="listing_1.html">HP</a></li>
		...
		<li><a href="listing_1.html">Samsung</a></li>
          ...
          <li><a href="listing_3.html">Networking</a>
            <div class="s_submenu">
              ...
              <ul class="s_list_1 clearfix">
                <li><a href="listing_1.html">Cables</a></li>
                <li><a href="listing_1.html">Routers</a></li>
                <li><a href="listing_1.html">Switches</a></li>
                <li><a href="listing_1.html">Equipment</a></li>
                <li><a href="listing_1.html">Network cards</a></li>
              </ul>
              
            </div>
          </li>
          <li><a href="listing_4.html">Gaming</a>
            <div class="s_submenu">
              <h3>GAME CONSOLES</h3>
              <ul class="s_list_1 clearfix">
                <li><a href="listing_1.html">Playstation</a></li>
                <li><a href="listing_1.html">Xbox</a></li>
                <li><a href="listing_1.html">Nintendo Wii</a></li>
                <li><a href="listing_1.html">Racing Wheels</a></li>
		
              </ul>
              <span class="clear border_eee"></span>
              <h3>TOP GAMES</h3>
              <ul class="s_list_1 clearfix">
                <li><a href="listing_1.html">NFS HP</a></li>
                <li><a href="listing_1.html">SplitSecond</a></li>
                <li><a href="listing_1.html">Eurotruck</a></li>
                <li><a href="listing_1.html">NFS Rivals</a></li>
                <li><a href="listing_1.html">Call of Duty</a></li>
                <li><a href="listing_1.html">FIFA 2018</a></li>
                <li><a href="listing_1.html">Flight Simulator</a></li>
                <li><a href="listing_1.html">Train Simulator</a></li>
              </ul>
            </div>
          </li>
          <li><a href="listing_5.html">Software</a>
            <div class="s_submenu">
              ...
              <ul class="s_list_1 clearfix">
                ...
                <li><a href="listing_1.html">Operating Systems</a></li>
                <li><a href="listing_1.html">Office suite</a></li>
                <li><a href="listing_1.html">Gaming software</a></li>
                <li><a href="listing_1.html">Graphics design</a></li>
                <li><a href="listing_1.html">Latest Antivirus</a></li>
                <li><a href="listing_1.html">Animation</a></li>
          ...
          <li><a href="">Shopping</a>
            <div class="s_submenu">
              ...
              <ul class="s_list_1 clearfix">
                ...
                <li><a href="listing_6.php">Real Estate</a></li>
              </ul>
            </div>
          </li>
      </div>
    ...
    <div id="category" class="grid_9">
      ...
      <div id="listing_options">
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            <li id="view_grid"><a href="listing_1.php"><span class="s_icon"></span>Grid</a></li>
            <li id="view_list" class="s_selected"><a href="listing_1.php"><span class="s_icon"></span>List</a></li>
          </ul>
        </div>
      </div>
...
<?php
    ...
    if(isset($_GET['action']) && $_GET['action']=="add"){
        ...
        if(isset($_SESSION['cart2'][$id])){
            ...
            $sql_s="SELECT * FROM electronics
                WHERE id_product={$id}";
            $query_s=mysqli_query($conn,$sql_s);
            if(mysqli_num_rows($query_s)!=0){
                $row_s=mysqli_fetch_array($query_s);
                  
                $_SESSION['cart2'][$row_s['id_product']]=array(
                        "quantity" => 1,
                        "price" => $row_s['price']
                    );
...
<div class="s_listing s_list_view clearfix">
 ...
 <?php
  require("dbconnect.php");
    ...
    $sql="SELECT * FROM electronics ORDER BY id_product DESC LIMIT 30";
...
?>
    ...
    <div id="right_col" class="grid_3">
      <div id="cart_side" class="s_box_1 s_cart_holder">
        <h2 class="s_secondary_color"><a href="cart.php?page=cart2"><img src="images/pic12.png" alt="Go to cart"</a></h2>
       ...
       <div id="categories_module" class="s_box">
        ...
        <div class="s_list_1">
          <ul>
            ...
            <li><a href="listing_1.php"><b>Electronics</b></a></li>
            <li><a href="listing_2.php"><b>Computers</b></a></li>
            <li><a href="listing_3.php"><b>Networking</b></a></li>
            <li><a href="listing_4.php"><b>Gaming</b></a></li>
            <li><a href="listing_5.php"><b>Software</b></a></li>
            <li><a href="listing_6.php"><b>Real Estate</b></a></li>
  ...
  <!-- ********************** --> 
   <div id="shop_info">
    <div id="shop_info_wrap">
      <div class="container_12">
        <div id="shop_description" class="grid_3"><img src="images/dummy/banner_5.jpg" title="MPESA" alt="MPESA" /> </div>
          
        <div id="shop_contacts" class="grid_3">
          <h2>Contact Us</h2>
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td valign="middle"><span class="s_icon_32"><span class="s_icon s_phone_32"></span>+254[0] 726 805 667 <br /></span></td>
            </tr>
   
            <tr>
             
	    <td valign="middle"><span class="s_icon_32"><span class="s_icon s_mail_32"></span>info@ojoinvestments.com</span></td> 
            </tr>
    ...
    <div id="footer_categories" class="clearfix">
      ...
      <div class="grid_2">
        ...
        <ul class="s_list_1">
          ...
          <li><a href="">Latest Antivirus</a></li>
