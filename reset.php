...
<div id="wrapper"> 
  ...
  <div id="header" class="container_12">
    <div class="grid_12">
    	...
    	<a id="site_logo" >Shoppica store - Premium e-Commerce Theme</a>
...
var pw2 = document.myForm.newpassword.value;


// check for a value in both fields.
if (pw1 == '' || pw2 == '' ) {
alert('one of the password field has been left blank.' );
...
<div id="form">
<form method="POST" id="create" class="clearfix"  action="resetpassword.php" onSubmit="return validatePwd()" name="myForm">

<tr><td><p>New password: &nbsp;</td> <td> <input type="password" id="newpassword" name='newpassword' /> </p></tr></td>
<tr><td><p>Confirm new password: &nbsp; </td><td><input type="password" id="repeatnewpassword" name='password' /> </p></tr></td>
