          ...
          <li><a >Products</a>
            <div class="s_submenu">
              ...
              <ul class="s_list_1 clearfix">
                ...
                <li><a href="products_list.php">List Product</a></li>
              </ul>
...
$qry = "SELECT * FROM `admin` WHERE `email`='".$_SESSION['username']."'";

$result= mysql_query($qry, $conn) or exit("SQL Error: ".mysql_error());
 $numrows=mysql_num_rows( $result);
 if($numrows==0):

echo "No user found".$_SESSION['username'];
...
?><h3 align="right" >SIGNED IN AS: <?php echo $row['name']; ?><br></h3>
