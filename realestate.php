...
echo 
header("location:realerror.html");

else:
//If details are filled, run a query

 $strSQL1= "INSERT INTO `realestate` (`product_name`,`product_desc`,`product_category`,`price`) values ('$product_name','$product_desc','$product_category','$price')";
 $result= mysql_query($strSQL1, $conn) or exit("SQL Error: ".mysql_error());
 
// Go back to realestate.html
