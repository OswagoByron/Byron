...
echo 
header("location:networkerror.html");

else:
//If details are filled, run a query

 $strSQL1= "INSERT INTO `networking` (`product_name`,`product_desc`,`product_category`,`price`) values ('$product_name','$product_desc','$product_category','$price')";
 $result= mysql_query($strSQL1, $conn) or exit("SQL Error: ".mysql_error());
 
// Go back to networking.html

echo 
header("location:networking.html");
endif;
