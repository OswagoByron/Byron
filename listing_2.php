  ...
  <div id="header" class="container_12">
    <div class="grid_12">
      ...
      <div id="categories" class="s_nav">
		...
		<li><a href="listing_2.html">Projectors</a></li>
              </ul>
      ...
      <div id="listing_options">
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            ...
            <li id="view_list" class="s_selected"><a href="listing_2.php"><span class="s_icon"></span>List</a></li>
          </ul>
        </div>
      </div>
...
<?php
    ...
    if(isset($_GET['action']) && $_GET['action']=="add"){
        ...
        if(isset($_SESSION['cartcomp'][$id])){
              
            $_SESSION['cartcomp'][$id]['quantity']++;
              
        }else{
             
            $sql_s="SELECT * FROM computers
                WHERE id_product={$id}";
            $query_s=mysqli_query($conn,$sql_s);
            if(mysqli_num_rows($query_s)!=0){
                $row_s=mysqli_fetch_array($query_s);
                  
                $_SESSION['cartcomp'][$row_s['id_product']]=array(
                        "quantity" => 1,
                        "price" => $row_s['price']
                    );
...
<div class="s_listing s_list_view clearfix">
 ...
 <?php
  require("dbconnect.php");
    $sql="SELECT * FROM computers ORDER BY id_product DESC LIMIT 30";
...
?>
        <tr>
            ...
            <td><a href="cartcom.php?page=listing_2&action=add&id=<?php echo $row['id_product'] ?>"><img src="images/pic_15.JPG" alt="cart"</a></td>
        </tr>
<?php
...
?>
    ...
    <div id="right_col" class="grid_3">
      <div id="cart_side" class="s_box_1 s_cart_holder">
        <h2 class="s_secondary_color"><a href="cartcom.php?page=cartcomp"><img src="images/pic12.png" alt="Go to cart""</a></h2>
